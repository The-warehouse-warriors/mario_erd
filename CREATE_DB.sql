...
-- -----------------------------------------------------
-- Table `marios_pizza`.`tempZipcodes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marios_pizza`.`tempZipcodes` ;

CREATE TABLE IF NOT EXISTS `marios_pizza`.`tempZipcodes` (
  `Zipcode` VARCHAR(100) NULL,
  `BreakStart` VARCHAR(100) NULL,
  `BreakEnd` VARCHAR(100) NULL,
  `City` VARCHAR(100) NULL,
  `Street` VARCHAR(100) NULL,
  `MunId` VARCHAR(100) NULL,
  `CityId` INT NULL,
  `StreetId` INT NULL)
ENGINE = InnoDB;
