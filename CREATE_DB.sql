...
CREATE TABLE IF NOT EXISTS `Marios_pizza`.`ServiceArea` (
  ...
  `UpdateBy` VARCHAR(45) NOT NULL,
  `Deleted` TINYINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`, `Shop_ID`, `StreetName_ID`),
  INDEX `fk_ZipCode_Shop1_idx` (`Shop_ID` ASC) VISIBLE,
  INDEX `fk_ZipCode_StreetName1_idx` (`StreetName_ID` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_ZipCode_StreetName1`
    FOREIGN KEY (`StreetName_ID`)
    REFERENCES `Marios_pizza`.`StreetName` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Marios_pizza`.`StreetName`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Marios_pizza`.`StreetName` ;

CREATE TABLE IF NOT EXISTS `Marios_pizza`.`StreetName` (
  `ID` INT NOT NULL,
  `StreetName` VARCHAR(75) NOT NULL,
